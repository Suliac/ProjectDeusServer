...
{
	SerializableSkillComponent::SerializableSkillComponent(Id componentId, GameObjectComponent::EComponentType componentType, const std::shared_ptr<const DeusCore::SkillInfos> originValue, uint32_t originMs, const std::shared_ptr<const DeusCore::SkillInfos> destinationValue, uint32_t destinationMs)
		: SerializableTimelineComponent<DeusCore::SkillInfos>(componentId, componentType, originValue, originMs, destinationValue, destinationMs)
	{
	}

	SerializableSkillComponent::~SerializableSkillComponent()
	{
	}

	void SerializableSkillComponent::Deserialize(DeusCore::Buffer512 & buffer)
	{
	...
	void SerializableSkillComponent::Serialize(DeusCore::Buffer512 & buffer) const
	{
	...
	uint16_t SerializableSkillComponent::EstimateAnswerCurrentSerializedSize() const
	{
