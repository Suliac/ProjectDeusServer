...
namespace DeusServer
{
	...
	{
	public:
		PacketObjectChangeCell(Id objectId, Id clientId, GameObject::EObjectType objectType, Id leftCellId, Id enteredCellId, std::vector<std::shared_ptr<GameObject>>& objectInCellsLeft, std::vector<std::shared_ptr<GameObject>>& objectInCellsEntered);
